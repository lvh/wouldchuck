...
var o11299 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11299["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11300 = temp__5455__auto____$1;
return (o11300["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10403__auto__ = f;
return (o__10403__auto__["toString"]).call(o__10403__auto__);
} else {
return "";
}
}catch (e11301){var _ = e11301;
return "";
}});
...
try{var o__10403__auto___11303 = t;
(o__10403__auto___11303["cljs$lang$ctorPrWriter"]).call(o__10403__auto___11303,t,writer);
}catch (e11302){var __11304 = e11302;
}
...
var char_code = (function (){var o__10403__auto__ = (new String(char$));
return (o__10403__auto__["charCodeAt"]).call(o__10403__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10403__auto__ = String;
return (o__10403__auto__["fromCharCode"]).call(o__10403__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11305 = num_code;
switch (G__11305) {
case (1):
return (185);
...
var o__10403__auto__ = String;
return (o__10403__auto__["fromCharCode"]).call(o__10403__auto__,superscript_code);
});
/**
...
}catch (e11307){var _e__10410__auto__ = e11307;
return false;
}})())){
...
var vec__11308 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11308,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o11311 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11311["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11312 = temp__5455__auto____$1;
return (o11312["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___11319 = arguments.length;
var i__4532__auto___11320 = (0);
while(true){
if((i__4532__auto___11320 < len__4531__auto___11319)){
args__4534__auto__.push((arguments[i__4532__auto___11320]));

var G__11321 = (i__4532__auto___11320 + (1));
i__4532__auto___11320 = G__11321;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11315){
var vec__11316 = p__11315;
var ns_detector = cljs.core.nth.call(null,vec__11316,(0),null);
...
var G__11322 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11323 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11322;
remaining_tokens = G__11323;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11313){
var G__11314 = cljs.core.first.call(null,seq11313);
var seq11313__$1 = cljs.core.next.call(null,seq11313);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11314,seq11313__$1);
});
...
var vec__11327 = cljs.core.split_with.call(null,(function (p1__11326_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11326_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11327,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11327,(1),null);
...
var vec__11330 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11330,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11330,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11333 = cljs.core.rest.call(null,remaining_tokens);
var G__11334 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11333;
name_tokens = G__11334;
continue;
} else {
...
var vec__11337 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11337,(0),null);
var arity = cljs.core.nth.call(null,vec__11337,(1),null);
var vec__11340 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11340,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11340,(1),null);
var vec__11343 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11343,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11343,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11343,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11343,(3),null);
...
var vec__11349 = result;
var munged_ns = cljs.core.nth.call(null,vec__11349,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11349,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11349,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11349,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11349,(4),null);
var arity = cljs.core.nth.call(null,vec__11349,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__11353 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__11353,(0),null);
var args = cljs.core.nth.call(null,vec__11353,(1),null);
var vec__11356 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__11359 = (arity + (1));
var G__11360 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11361){
var vec__11362 = p__11361;
var arity = cljs.core.nth.call(null,vec__11362,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11362,(1),null);
...
return cljs.core.get.call(null,arities,p1__11365_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11366_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11369){
var vec__11370 = p__11369;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11370,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11367){
var G__11368 = cljs.core.first.call(null,seq11367);
var seq11367__$1 = cljs.core.next.call(null,seq11367);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11368,seq11367__$1);
});
...
var G__11376 = arg;
var G__11376__$1 = (((G__11376 instanceof cljs.core.Keyword))?G__11376.fqn:null);
switch (G__11376__$1) {
...
var map__11378 = options;
var map__11378__$1 = ((((!((map__11378 == null)))?(((((map__11378.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11378.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11378):map__11378);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11378__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11378__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11378__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11378__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11379 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11379,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11379,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11379,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11379,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11379,(4),null);
var arity = cljs.core.nth.call(null,vec__11379,(5),null);
...
var o__10403__auto__ = f;
return (o__10403__auto__["getBasis"]).call(o__10403__auto__);
});
/**
...
}catch (e11383){var _e__10410__auto__ = e11383;
...
var G__11384 = (obj[cljs.core.first.call(null,path)]);
var G__11385 = cljs.core.rest.call(null,path);
obj = G__11384;
path = G__11385;
continue;
} else {
...
return (function (accum,p__11386){
var vec__11387 = p__11386;
var bit = cljs.core.nth.call(null,vec__11387,(0),null);
var protocol = cljs.core.nth.call(null,vec__11387,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11390){
var vec__11391 = p__11390;
var ns = cljs.core.nth.call(null,vec__11391,(0),null);
var name = cljs.core.nth.call(null,vec__11391,(1),null);
var selector = cljs.core.nth.call(null,vec__11391,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__11396,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11396,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11396,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11394_SHARP_){
return (obj[cljs.core.first.call(null,p1__11394_SHARP_)]);
});})(name,sorted_matches,vec__11396,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
