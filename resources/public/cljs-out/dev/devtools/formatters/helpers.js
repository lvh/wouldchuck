...
var G__11401 = devtools.prefs.pref.call(null,v);
v = G__11401;
continue;
} else {
return v;
...
}catch (e11404){var _e__10410__auto__ = e11404;
return false;
}})();
...
}catch (e11408){var _e__10410__auto__ = e11408;
return false;
}})();
...
}catch (e11410){var _e__10410__auto__ = e11410;
return false;
}}
}
});
...
var vec__11412 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11412,(0),null);
var name = cljs.core.nth.call(null,vec__11412,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11415_SHARP_);
}),template);
});
